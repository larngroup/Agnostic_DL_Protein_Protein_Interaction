...
class ConvLstm:
	# BASED ON THIS ARTICLE: https://www.mdpi.com/1420-3049/23/8/1923 (already have it downloaded, search for molecules-23)
	def __init__(self, paddVal,numFilters, kernelSize, activationFun, poolSize, batch, epochs, dropRate, 
		learnRate, path, aaSize, opt, dataToLoad, concatenateOrMultiply):
